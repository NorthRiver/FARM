...
$(bin_dir)FARM.exe: $(obj_dir)robot.o $(obj_dir)socket.o $(obj_dir)partie.o $(obj_dir)cJSON.o $(obj_dir)bebotte.o $(obj_dir)Sdl_init.o $(obj_dir)Sdl_fenetres.o $(obj_dir)Sdl_main.o
	$(CC) -o $@ $^ $(LDFLAGS)
